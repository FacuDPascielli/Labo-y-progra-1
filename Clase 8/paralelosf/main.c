...
void ordenarAlumnosSexLegNom( int leg[], int age[], char sex[], int n1[], int n2[], float prom[], int tam);
...
void ordenarAlumnosSexLeg( nom[][20], int leg[], int age[], char sex[], int n1[], int n2[], float prom[], int tam){
